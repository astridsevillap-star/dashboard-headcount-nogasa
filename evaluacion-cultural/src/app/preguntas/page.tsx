  ...
  return (
    <div className="fade-rise flex flex-col gap-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div><h1 className="text-[22px] font-semibold text-ink-900">Preguntas de evaluación</h1><p className="mt-1 max-w-2xl text-sm text-ink-500">Cuestionario único de 20 preguntas para todos los líderes evaluados. Puedes editar el texto, cambiar la competencia o desactivar preguntas.</p></div>
