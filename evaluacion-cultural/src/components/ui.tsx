...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-[12px] border border-dashed border-ink-300 bg-surface px-6 py-16 text-center">
      ...
      <p className="mt-1.5 max-w-md text-sm leading-relaxed text-ink-500">{body}</p>
...
export function KpiCard({
  ...
  return (
    <div className="rounded-[12px] border border-line bg-surface p-4">
      ...
      <p className={`mt-1.5 tnum font-mono text-[26px] font-semibold leading-none ${toneClass}`}>
        {value}
      </p>
